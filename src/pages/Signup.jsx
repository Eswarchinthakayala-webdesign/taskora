      ...
      >
        ...
        <div className="relative z-10 text-center md:text-left space-y-6 max-w-lg">
          ...
          <p className="text-zinc-300 text-lg leading-relaxed">
            Experience a workspace designed for tomorrow.  
            <span className="text-orange-400"> Taskora </span> empowers you with  
            futuristic tools to manage tasks, collaborate effortlessly,  
            and achieve more.
          </p>
          <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-2 text-sm">
            <span className="flex items-center gap-2 text-orange-400">
              <Rocket className="w-5 h-5" /> Lightning Fast
            </span>
            <span className="flex items-center gap-2 text-orange-400">
              <Sparkles className="w-5 h-5" /> AI Enhanced
            </span>
            <span className="flex items-center gap-2 text-orange-400">
